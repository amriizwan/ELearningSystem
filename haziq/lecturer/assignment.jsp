...
<html>
    <head>
        ...
        <title>Assignments — MyStudyZone</title>
        <style>
        ...
        <main class="lg:ml-64 min-h-screen flex">
            ...
            <div class="w-64 flex-shrink-0 bg-white border-r border-slate-100 flex flex-col min-h-screen">
                <div class="px-5 py-5 border-b border-slate-100">
                    <h1 class="text-base font-semibold text-slate-900">Assignments</h1>
                ...
                <div class="flex-1 overflow-y-auto py-2">
                    ...
                    <a href="assignment?course_id=${lectCourses.courseId}"
                       class="flex items-center justify-between px-4 py-3 border-l-2 transition
                                ${lectCourses.courseId == param.course_id ? 'bg-slate-50 border-indigo-600' : 'border-transparent hover:bg-slate-50 hover:border-slate-200' }">
                            ...
                            <form method="POST" action="assignment?course_id=${firstId}&view=new"
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="4"
                                              ...
                                              class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-slate-400 transition resize-none"></textarea>
                                </div>
                        ...
                        <div class="max-w-xl mx-auto px-8 py-8">
                            ...
                            <form method="POST" action="assignment?course_id=${firstId}&asgn_id=${selectedAssign.id}&view=edit"
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-slate-700 mb-1.5">Description</label>
                                    <textarea name="description" rows="4"
                                              class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-slate-400 transition resize-none">${selectedAssign.description}</textarea>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                            ...
                            <form method="POST" action="assignment?course_id=${firstId}&asgn_id=${param.asgn_id}&submission_id=${forMark.id}&view=mark"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <input type="number" name="mark" id="mark-input" required
                                               ...
                                               class="w-32 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-slate-400 transition text-center font-semibold"/>
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea name="lecturer_comment" rows="4"
                                              ...
                                              class="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-slate-400 transition resize-none">${forMark.lecturerComment}</textarea>
                                </div>
