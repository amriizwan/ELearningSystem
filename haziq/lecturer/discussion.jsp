...
<html>
    ...
    <body class="bg-slate-50 text-slate-900 antialiased min-h-screen">
        ...
        <aside class="w-64 bg-white border-r border-slate-100 flex flex-col py-6 fixed h-full">
            ...
            <main class="lg:ml-64 flex-1 flex">

                <%-- LEFT PANEL: post list + create form --%>
                <div class="w-80 border-r border-slate-100 bg-white flex flex-col">
                    <div class="px-4 py-4 border-b border-slate-100">
                        <h1 class="text-base font-semibold text-slate-900">Discussion</h1>
                    </div>

                    <%-- Success / Error --%>
                    <c:if test="${not empty sessionScope.success}">
                        <div class="mx-3 mt-3 bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs rounded-lg px-3 py-2">
