...
<main class="lg:ml-64 min-h-screen p-5 sm:p-8">
    ...
    <%-- ── Header ── --%>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-slate-900 tracking-tight">${greeting}, ${firstName}!</h1>
        <p class="text-sm text-slate-400 mt-1.5">${today}</p>
    </div>

    <%-- ── Stat cards ── --%>
    <div class="grid grid-cols-5 gap-4 mb-8">

        <div class="bg-white border border-slate-100 rounded-2xl p-5 transition hover:shadow-md hover:border-indigo-200">
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="lectureCourses" class="text-xs text-slate-400 hover:text-slate-700 transition">View all →</a>
            </div>
