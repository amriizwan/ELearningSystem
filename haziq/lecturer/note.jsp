        ...
        <main class="lg:ml-64 min-h-screen flex">
            ...
            <div class="w-64 flex-shrink-0 bg-white border-r border-slate-100 flex flex-col min-h-screen">
                <div class="px-5 py-5 border-b border-slate-100">
                    <h1 class="text-base font-semibold text-slate-900">Notes</h1>
                    ...
                    <c:if test="${!noteList.isEmpty()}">
                        ...
                        <a href="note?course_id=${noteList.id}&&title=${noteList.title}"
                           class="flex items-center justify-between px-4 py-3 border-l-2 transition
                                  ${noteList.id == param.course_id ? 'bg-indigo-50 border-indigo-600' : 'border-transparent hover:bg-slate-50 hover:border-indigo-200'}">
            ...
            <c:choose>
                ...
                <div class="max-w-xl mx-auto px-8 py-8">
                    <div class="flex items-center gap-3 mb-6">
                        <a href="note?course_id=${selectedNote.course_id}" class="text-slate-400 hover:text-slate-700 transition">
                    ...
                    <form method="POST" action="note"
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="title" required value="${selectedNote.title}"
                                   class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-indigo-500 transition"/>
                        </div>
                        <div class="mb-4">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="course_id" required
                                    class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-indigo-500 transition">
                        ...
                        <div class="mb-4">
                            ...
                            <label for="note_file"
                                   class="flex flex-col items-center justify-center border-2 border-dashed border-slate-200
                                          rounded-xl py-8 cursor-pointer hover:border-indigo-400 hover:bg-slate-50 transition"
                                   id="upload-label">
                ...
                <!-- Toast -->
                       <c:if test="${not empty sessionScope.success}">
                               <div id="toast" class="bg-emerald-50 border border-emerald-100 text-emerald-700 text-sm rounded-xl px-4 py-3 mb-5 w-full">
                                   ${sessionScope.success}
                               </div>
                               <c:remove var="success" scope="session"/>
                       </c:if>
                       <c:if test="${not empty sessionScope.error}">
                               <div id="toast" class="bg-red-50 border border-red-100 text-red-700 text-sm rounded-xl px-4 py-3 mb-5 w-full">
                                   ${sessionScope.error}
                               </div>
                    ...
                    <div class="flex gap-3 mb-5">
                        <div class="relative flex-1">
                            ...
                            <input type="text" name="q" id="searchInput" oninput="applyFilters()"
                                   ...
                                   class="w-full pl-9 pr-4 py-2.5 text-sm border border-slate-200 rounded-xl focus:outline-none focus:border-indigo-500 bg-white transition"/>
                        </div>
                        <div class="flex gap-2">
                            <button type="button"
                            ...
                            <button type="button"
                                    class="filter-btn px-4 py-2 rounded-xl border border-slate-200 bg-white text-sm hover:bg-slate-50"
                        ...
                        <c:otherwise>
                            <div id="notesContainer" class="flex flex-col gap-3">
                                <c:forEach var="listNote" items="${listNote}">
                                    <div class=" note-card bg-white border border-slate-100 rounded-xl px-5 py-4 flex items-center gap-4 hover:border-indigo-200 transition group"
