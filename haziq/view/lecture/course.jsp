<%-- 
    Document   : course
    Created on : Jun 26, 2026, 1:20:32 AM
    Author     : Haziq
--%>
<%@ taglib prefix="c" uri="jakarta.tags.core" %>
<%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
<% pageContext.setAttribute("currentPage", "courses"); %>
            ...
            <!-- Toast -->
             ...
             <div class="flex flex-col sm:flex-row gap-3 mb-5">
                ...
                <div class="flex gap-2">
                    <a href="lectureCourses?show=all"
                    ...
                    <a href="lectureCourses?show=teaching" 
            ...
            <c:if test="${not empty courses}">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 h-fit">
                    ...
                    <div class=" course-card bg-white border rounded-2xl p-5 flex flex-col transition hover:shadow-sm h-full
                        ...
                        <!-- Action button -->
                        <form method="POST" action="lectureCourses">
