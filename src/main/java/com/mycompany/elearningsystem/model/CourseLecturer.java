...
public class CourseLecturer {
    ...
    public CourseLecturer(String id, String title, String description, String course_id, String lecture_id, int student_count, int note_count, int asgn_count, int quiz_count, int lecturer_count, int is_mine) {
        this.id = id;
        this.title = title;
...
////    }
//
//    public CourseLecturer id, String course_id, String lecture_id, int student_count, int note_count, int asgn_count, int quiz_count, int lecturer_count, int is_mine) {
//        this.id = id;
//        this.course_id = course_id;
//        this.lecture_id = lecture_id;
//        this.student_count = student_count;
