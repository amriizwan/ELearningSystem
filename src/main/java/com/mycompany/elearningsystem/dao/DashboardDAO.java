...
import com.mycompany.elearningsystem.util.DateUtil;
...
public class DashboardDAO {
    ...
    public List<Assignment> getUpcomingTasks(int studentId) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                assignment.setStatus(rs.getString("urgency"));
    ...
    public ArrayList<Course> getCourses(int lecturerId) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                course.setEnrollmentCount(rs.getInt("student_count"));
                course.setNoteCount(rs.getInt("note_count"));
                course.setAssignmentCount(rs.getInt("asgn_count"));
    ...
    public ArrayList<AssignmentSubmission> getPendingSubmissions(int lecturerId) {
        ArrayList<AssignmentSubmission> submissions = new ArrayList<>();
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                sub.setId(rs.getInt("submission_id"));
                ...
                sub.setMark(rs.getInt("max_marks"));
                sub.setCourseName(rs.getString("course_title"));
                sub.setInitials(DateUtil.getInitials(sub.getStudentName()));
                sub.setTimeAgo(DateUtil.timeAgo(sub.getSubmittedAt()));
                submissions.add(sub);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<QuizAttemptResult> getRecentAttempts(int lecturerId) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                int percent = DateUtil.calcPercent(
                attempt.getScore(),
                attempt.getTotalQuestions());
                attempt.setPercentage(percent);
                attempt.setPercentageColor(DateUtil.getPctColorClass(percent));
                attempt.setInitials(DateUtil.getInitials(attempt.getStudentName()));
